...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "test/helper.rb",
    "test/test_json_output_helper.rb"
  ]
  s.homepage = %q{http://github.com/craigulliott/json_output_helper}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{ActionController helper to normalize JSON output}
